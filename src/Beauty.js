...
function Beauty() {
  return (
    ...
    <div className='form'>
        ...
        <h1 className="h11">BEAUTY</h1>
        <br></br><br></br>
        <div className="div1"><a><Link to="/Makeup"><button className="b2">Makeup</button></Link></a></div>
        <br></br>
        <div className="div1">Haircare</div>
        <br></br>
        <div className="div1">Skincare</div>
        <br></br>
        <div className="div1">Bath & Bodycare</div>
        <br></br>
        <div className="div1">Fragrances</div>
        <br></br><br></br><br></br>
        <div> 
